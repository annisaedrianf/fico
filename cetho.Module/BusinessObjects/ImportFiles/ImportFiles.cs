...
namespace cetho.Module.BusinessObjects
{
    ...
    public class ImportFiles : XPObject
    {
        ...
        [XafDisplayName("File Upload"), ToolTip("File Upload")]
        ...
        public void UpdateTempate(string sDataType = "")
        {
            ...
            if (ObjectName.ObjectName != null)
            {
                if (ObjectName.ObjectName !=""  )
                {
                    ...
                    string objectType =  ObjectName.FullObjectName;
        ...
        public void UpdateTempate<T>(T ObjType, string objMaster = null, string sMasterPropertyName = "") where T : Type
        {
            ...
            //DataType = ObjType.Name.Substring(1, ObjType.Name.Length );
        ...
        public  void ImportData()
        {
            ...
            ////XPClassInfo classInfo = session.DefaultSession.Dictionary.GetClassInfo("cetho.Module.BusinessObjects",objectType);
            // XPClassInfo oclassInfo = Session.GetClassInfo("Nucleus.Module" , objectType);

            //// Type type = classInfo.GetType();
            //Type oType = oclassInfo.GetType();
            //Type Objecttype = Type.GetType("cetho.Module.BusinessObjects." + iObjectMap.GPN)
            if (ObjectName.ObjectName != null)
            {
                //string objectType = "cetho.Module.BusinessObjects." + ObjectName.FullObjectName;
                string objectType =  ObjectName.FullObjectName;
