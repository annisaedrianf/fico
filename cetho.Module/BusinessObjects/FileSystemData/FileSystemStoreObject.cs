...
namespace cetho.Module.BusinessObjects
{
    ...
    public class FileSystemStoreObject : BaseObject, IFileData, IEmptyCheckable {
        ...
        private FileSystemData FileSystemDataModule= new FileSystemData();
        ...
        public string FolderName
        {
            get
            {
                return FileSystemDataModule.FileSystemStoreLocation;
            }
        }
        ...
        public  void SaveFileToStoreBaseRealName(string newRealFileName)
        {
            if (!string.IsNullOrEmpty(newRealFileName))
            {
                try
                {
                    using (Stream destination = File.OpenWrite(newRealFileName))
                    {
